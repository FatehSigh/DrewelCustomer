...
//        holder.itemView.tv_quantity.text = weight
        var weight: String = ""
      /*  if (wishList[position].weightIn!!.equals("Ml",true))
            weight = wishList[position].weight + " " + mContext.getString(R.string.Ml)
        else if (wishList[position].weightIn!!.equals("Kg",true))
            weight = wishList[position].weight + " " + mContext.getString(R.string.Kg)
        else if (wishList[position].weightIn!!.equals("Lt",true))
            weight = wishList[position].weight + " " + mContext.getString(R.string.Lt)
        else if (wishList[position].weightIn!!.equals("Gm",true))*/
            weight = wishList[position].weight + " " + wishList[position].weightIn!!
