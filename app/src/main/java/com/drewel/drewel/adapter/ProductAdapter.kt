...
import com.drewel.drewel.activity.WelcomeActivity
...
//        holder.itemView.imv_product.layoutParams = relativePram
      ...
      //  if (productList[position].weightIn!!.equals("Ml",true))
        //    holder.itemView.tv_quantity.text = productList[position].weight + " " + mContext.getString(R.string.Ml)
      //  else if (productList[position].weightIn!!.equals("Kg",true))
        //    holder.itemView.tv_quantity.text = productList[position].weight + " " + mContext.getString(R.string.Kg)
        //else if (productList[position].weightIn!!.equals("Lt",true))
       //     holder.itemView.tv_quantity.text = productList[position].weight + " " + mContext.getString(R.string.Lt)
      //  else if (productList[position].weightIn!!.equals("Gm",true))
            holder.itemView.tv_quantity.text = productList[position].weight + " " + productList[position].weightIn
...
//        holder.itemView.tv_quantity.text = weight
    ...
    inner class CategoryHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            ...
            var value = com.drewel.drewel.utill.Utils.getInstance().dpToPix(mContext, 60)
            if (visibility == View.VISIBLE) {
                value = com.drewel.drewel.utill.Utils.getInstance().dpToPix(mContext, 150)
                imageViewHeight = (height) / 2 - 220
            } else
                imageViewHeight = (height) / 2 - 150
            value = com.drewel.drewel.utill.Utils.getInstance().dpToPix(mContext, 100)
