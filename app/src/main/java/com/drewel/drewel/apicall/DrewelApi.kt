package com.drewel.drewel.apicall

import com.google.gson.JsonObject
import com.drewel.drewel.apicall.requestmodel.CheckOutRequest
import com.drewel.drewel.apicall.requestmodel.SignUpRequest
import com.drewel.drewel.apicall.responsemodel.addaddressresponsemodel.AddAddressResponse
import com.drewel.drewel.apicall.responsemodel.addtocartresponsemodel.AddToCartResponse
import com.drewel.drewel.apicall.responsemodel.applycouponresponsemodel.ApplyCouponResponse
import com.drewel.drewel.apicall.responsemodel.applyloyaltypointresponsemodel.ApplyLoyaltyPointResponse
import com.drewel.drewel.apicall.responsemodel.baseresponsemodel.BaseResponse
import com.drewel.drewel.apicall.responsemodel.cartdetailresponsemodel.CartDetailResponse
import com.drewel.drewel.apicall.responsemodel.categoryresponsemodel.CategoryListResponse
import com.drewel.drewel.apicall.responsemodel.checkoutresponsemodel.CheckOutResponse
import com.drewel.drewel.apicall.responsemodel.couponresponsemodel.CouponListResponse
import com.drewel.drewel.apicall.responsemodel.deliveryaddressresponsemodel.AddressListResponse
import com.drewel.drewel.apicall.responsemodel.deliverychargesresponsemodel.DeliveryChangesResponse
import com.drewel.drewel.apicall.responsemodel.driverlocationresponsemodel.DriverLocationResponse
import com.drewel.drewel.apicall.responsemodel.googledirectionresultmodel.DirectionResults
import com.drewel.drewel.apicall.responsemodel.loginresponsemodel.LoginResponse
import com.drewel.drewel.apicall.responsemodel.loyaltypointresponsemodel.LoyaltyPointResponse
import com.drewel.drewel.apicall.responsemodel.myorderdetailresponsemodel.MyOrderDetailResponse
import com.drewel.drewel.apicall.responsemodel.myorderresponsemodel.MyOrderResponse
import com.drewel.drewel.apicall.responsemodel.notificationresponsemodel.NotificationResponse
import com.drewel.drewel.apicall.responsemodel.productRequestresponsemodel.ProductRequestResponse
import com.drewel.drewel.apicall.responsemodel.productdetailresponsemodel.ProductDetailResponse
import com.drewel.drewel.apicall.responsemodel.productlistresponsemodel.ProductListResponse
import com.drewel.drewel.apicall.responsemodel.profileresponsemodel.ProfileResponse
import com.drewel.drewel.apicall.responsemodel.resendOtpresponsemodel.ResendOTPResponse
import com.drewel.drewel.apicall.responsemodel.reviewResponseModel.ReviewListResponse
import com.drewel.drewel.apicall.responsemodel.searchproductresponsemodel.SearchProductResponse
import com.drewel.drewel.apicall.responsemodel.searchsuggestionresponsemodel.SearchSuggestionResponse
import com.drewel.drewel.apicall.responsemodel.unreadnotificationresponsemodel.UnreadNotificationResponse
import com.drewel.drewel.apicall.responsemodel.walletTransactionResponseModel.TransactionResponse
import com.drewel.drewel.apicall.responsemodel.wishlistresponsemodel.WishlistResponse
...
//        const val ABOUT_US = "https://56.octallabs.com/drewel/about-us"
    ...
    @Headers("Content-Type: application/json")
    @POST("add_chat")
    fun add_chat(@Body logoutRequest: Map<String, String>): Observable<com.drewel.drewel.apicall.responsemodel.addchatresponsemodel.BaseResponse>
    ...
    @Headers("Content-Type: application/json")
    @POST("delivery_slot_check")
    fun deliverySlotCheck(@Body applyCouponRequest: Map<String, String>): Observable<JsonObject>
    ...
    fun order_address_save(@Body addressListRequest: Map<String, String>): Observable<com.drewel.drewel.apicall.responsemodel.saveaddressresponsemodel.AddressListResponse>
