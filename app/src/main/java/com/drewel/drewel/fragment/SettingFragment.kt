...
import com.drewel.drewel.activity.*
import com.drewel.drewel.activity.BaseActivity.Companion.isLanguageChange
...
//                    setDynamicallyParam(pref!!.getPreferenceIntData(pref!!.UNREAD_COUNT).toString())
    ...
    override fun onStart() {
        ...
        if (pref!!.getPreferenceStringData(pref!!.KEY_USER_ID).isEmpty())
         tv_sign_out.text=getString(R.string.login)
