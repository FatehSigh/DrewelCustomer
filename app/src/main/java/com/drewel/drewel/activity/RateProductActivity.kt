...
import com.drewel.drewel.adapter.ReviewListAdapter
...
import com.drewel.drewel.apicall.responsemodel.reviewResponseModel.Review
        ...
        when (view.id) {
            R.id.DoneBt -> {
                ...
                if (ratingBar.rating == 0f)
                    com.drewel.drewel.utill.Utils.getInstance().showToast(this, getString(R.string.rate_product_validation))
                else if (tv_product_desc.text.toString().isEmpty())
                    com.drewel.drewel.utill.Utils.getInstance().showToast(this, getString(R.string.review_product_validation))
