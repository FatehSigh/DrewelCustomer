...
import com.drewel.drewel.apicall.responsemodel.profileresponsemodel.Data
...
import com.drewel.drewel.prefrences.Prefs.Companion.prefs
                ...
                if (validateEditProfile()) {
                    if (!pref!!.getPreferenceStringData(prefs!!.KEY_MOBILE).equals(edt_profile_mobile_number.text.toString())) {
                        ...
                        if (txt_verify.text.toString().equals(getString(R.string.verified))) {
                            if (isNetworkAvailable())
                                callEditProfiledApi()
                        } else com.drewel.drewel.utill.Utils.getInstance().showToast(this, getString(R.string.verify_otp))
