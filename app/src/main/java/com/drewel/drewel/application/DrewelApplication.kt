package com.drewel.drewel.application
...
//        logUser()
    ...
    override fun onCreate() {
        ...
        val defaultBitmap1 = com.drewel.drewel.utill.Utils.getInstance().drawableToBitmap(ContextCompat.getDrawable(this, R.mipmap.default_image)!!)
